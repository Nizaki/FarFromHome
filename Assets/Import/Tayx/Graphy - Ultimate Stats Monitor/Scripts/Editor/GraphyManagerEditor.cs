...
namespace Tayx.Graphy
{
  ...
  internal class GraphyManagerEditor : Editor
  {
    ...
    #endregion Section -> Advanced Settings
    ...
    #endregion Methods -> Public Override
