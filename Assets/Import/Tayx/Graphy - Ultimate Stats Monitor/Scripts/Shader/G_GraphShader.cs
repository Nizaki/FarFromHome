...
namespace Tayx.Graphy
{
  ...
  public class G_GraphShader
  {
    ...
    #endregion Variables -> Array

    #region Variables -> Image

    public Image Image = null;

    #endregion Variables -> Image
    ...
    #endregion Variables -> Thresholds
